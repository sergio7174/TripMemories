...
export default function  SignInScreen() {
  ...
  return(
   ...
   <ScreenWrapper>
      <View className="flex justify-between h-full mx-4" style={{backgroundColor:'#9ca3af'}}>
        <View>
            ...
            <View className="flex-row justify-center my-3 mt-1">
                <Image className="h-40 w-40" source={require('../assets/images/SIGIN02.jpg')} style={{borderRadius:20, borderWidth:5, borderColor:'black'}}/>
            </View>
